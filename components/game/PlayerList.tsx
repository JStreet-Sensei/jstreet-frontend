    ...
    <>
      <div className="mt-2">
        <div className="mt-2 pt-5">
          <div className="sm:float-left mb-5 sm:mb-0 bg-white text-lg font-medium rounded-md">
            {usePlayers ? usePlayers[0] : <></>}
          </div>
          <div className="sm:float-right bg-white text-lg font-medium rounded-md">
